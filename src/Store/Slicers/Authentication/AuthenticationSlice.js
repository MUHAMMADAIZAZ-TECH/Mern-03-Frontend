...
import { SignIn,SignUp,verifyEmailUrl,resetPassword,verifyResetPasswordurl,UpdateNewPassword} from '../../apis';
...
export const verifyemailurl = createAsyncThunk('verifyemailurl',async (params) =>{
...
export const verifyresetpasswordurl = createAsyncThunk('verifyresetpasswordurl',async (params) =>{
  const response = await verifyResetPasswordurl(params);
  return response;
})
export const updatenewpassword = createAsyncThunk('updatenewpassword',async (params) =>{
